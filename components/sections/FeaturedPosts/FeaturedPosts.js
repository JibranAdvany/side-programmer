...
const FeaturedPosts = (props) => {
  return (
    <section className="mt-10 md:mt-20 px-2">
      <h2 className="font-light text-3xl md:text-5xl">Top Picks for today!</h2>
      <div className="flex justify-around flex-wrap mx-auto mt-4 md:mt-8">
        {/* Card */}
        {props.data.map((post) => (
          <div
            key={post.fields.slug}
            className="w-[300px] overflow-hidden sm:mr-3 md:mr-6 mt-6 md:mt-12 rounded-lg flex flex-col justify-between bg-gray-100 shadow-md"
          >
            <Card
